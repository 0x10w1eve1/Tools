...
# automate ubuntu customization, r option is non-interactive except for function rmsnapnstuff (see comments).
...
getTools (){
	...
	DEBIAN_FRONTEND=noninteractive apt -y install wireshark curl nmap sublime-text cherrytree gnome-tweaks gnome-tweak-tool ssh apache2 net-tools git aircrack-ng firefox
	#music tools
